# University.KhNURE.Web-Т.Practice-4

## What is the project about?

Repository is for educational purpose - doing practical class' [task №4](Практична%20робота%20№4.docx) on the
discipline *"Web technologies and web design"* in
the university "[Kharkiv National University of Radio Electronics][1]".

## What is the purpose of this project?

The **purpose** of the project is ***doing practical task №4*** on the discipline *"Web technologies and web design"*.
...
For running the project you needn't nothing. You can run the [index.html](html/index.html) file from your explorer or from IDEA.
...
4. Adds this repository to yours with name `origin` (you can change it, if you want):
    ```
   $ git remote add origin git@github.com:StasonMendelso/University.KhNURE.Web-T.Practice-4.git
   ```
...
Run the project using the [index.html](html/index.html) file.
